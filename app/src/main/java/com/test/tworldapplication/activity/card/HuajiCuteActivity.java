...
public class HuajiCuteActivity extends BaseActivity implements PullToRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        area = BaseUtils.getArea(HuajiCuteActivity.this);
        getRegularList();
...
//
        ...
        myAdapter = new MyAdapter(HuajiCuteActivity.this, list);
        contentView.setAdapter(myAdapter);
        contentView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent();
                intent.setClass(HuajiCuteActivity.this, HuajiCuteActivity.class);
//                    startActivity(HuajiCuteActivity.class);
    ...
    private void startActivity(Class clazz) {
        Intent intent = new Intent(HuajiCuteActivity.this, clazz);
        startActivity(intent);
...
//        WindowManager.LayoutParams lp = HuajiCuteActivity.this.getWindow().getAttributes();
//        lp.alpha = 0.5f;
//        HuajiCuteActivity.this.getWindow().setAttributes(lp);
            ...
            switch (view.getId()) {
                ...
                case R.id.ll_state:
                    if (regularList.size() > 0)
                        Util.createDialog(HuajiCuteActivity.this, regularList, tvRegular, new OnSelectListener() {
                            @Override
                        ...
                        Toast.makeText(HuajiCuteActivity.this, "请稍后", Toast.LENGTH_SHORT).show();
                    break;
...
//            Log.d("aaa", list.get(position).getStatus());
    ...
    private void getRegularList() {
        ...
        postCuteRegular.setSession_token(Util.getLocalAdmin(HuajiCuteActivity.this)[0]);
    ...
    private void getDailiData() {
        ...
        postAgentsLiang.setSession_token(Util.getLocalAdmin(HuajiCuteActivity.this)[0]);
        ...
        new CardHttp().getAgentsLiangList(httpPost, new Subscriber<HttpRequest<RequestLiangAgents>>() {
            ...
            public void onNext(HttpRequest<RequestLiangAgents> requestLiangAgentsHttpRequest) {
                if (requestLiangAgentsHttpRequest.getCode() == BaseCom.NORMAL) {
                    ...
                    Util.gotoActy(HuajiCuteActivity.this, LoginActivity.class);
                }
            }
        });
