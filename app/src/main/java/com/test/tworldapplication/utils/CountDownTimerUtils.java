...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        long n = millisUntilFinished / 1001;
        Log.d("ccc", n + "");
        textView.setText(n + "秒");  //设置倒计时时间
//        mTextView.setBackgroundResource(R.drawable.bg_identify_code_press); //设置按钮为灰色，这时是不能点击的
        ...
        ForegroundColorSpan span = new ForegroundColorSpan(ContextCompat.getColor(AppManager.getAppManager().currentActivity(),R.color.colorBlue1));
        /**
        ...
        spannableString.setSpan(span, 0, s, Spannable.SPAN_INCLUSIVE_EXCLUSIVE);//将倒计时的时间设置为红色
