...
public class DoubleDatePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public DoubleDatePickerDialog(Context context, String title, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context,title, 0, callBack, year, monthOfYear, dayOfMonth);
    }

    public DoubleDatePickerDialog(Context context, String title, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                                  int dayOfMonth) {
        this(context,title, 0, callBack, year, monthOfYear, dayOfMonth, true);
    }
