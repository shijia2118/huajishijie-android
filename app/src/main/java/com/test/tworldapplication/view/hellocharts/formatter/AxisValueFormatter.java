...
public interface AxisValueFormatter {
    ...
    /**
     * Formats AxisValue for manual(custom) axis. HttpRequest is stored in (output) formattedValue array. Method
     ...
     * decimal separator. HttpRequest is stored in given array. Method returns number of chars for formatted value. The
