...
public class ValueFormatterHelper {
    ...
    /**
     * Formats float value. HttpRequest is stored in (output) formattedValue array. Method
     ...
     * Note: PostLogin defaultDigitsNumber is used only if you didn't change decimalDigintsNumber value using
